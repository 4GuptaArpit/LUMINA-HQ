...
"[project]/lib/organization-sync.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function ensureUserInDatabase(clerkUserId) {
...
async function syncOrganizationMembership(clerkUserId, clerkOrgId) {
    const client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$clerkClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["clerkClient"])();
    const memberships = await client.users.getOrganizationMembershipList({
        userId: clerkUserId
    });
    const membership = memberships.data.find((item)=>item.organization.id === clerkOrgId);
    if (!membership) {
        return null;
    }
    const user = await ensureUserInDatabase(clerkUserId);
    const organization = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organization.upsert({
        where: {
            clerkOrgId
        },
        update: {
            name: membership.organization.name,
            slug: membership.organization.slug || slugifyOrganizationName(membership.organization.name)
        },
        create: {
            clerkOrgId,
            name: membership.organization.name,
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizationMember.upsert({
        where: {
...
"[project]/app/(dashboard)/[orgSlug]/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organization$2d$sync$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/organization-sync.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organization$2d$sync$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organization$2d$sync$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function OrgLayout({ children, params }) {
    ...
    // Get organization
    let organization = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organization.findUnique({
        where: {
            slug: orgSlug
        }
    });
    if (!organization) {
        ...
        const matchingMembership = memberships.data.find((item)=>item.organization.slug === orgSlug);
        if (matchingMembership) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organization$2d$sync$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["syncOrganizationMembership"])(userId, matchingMembership.organization.id);
            organization = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organization.findUnique({
                where: {
                    slug: orgSlug
                }
            });
    ...
    if (!organization) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])("/select-org");
    }
    // Check if user is member
    let membership = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizationMember.findFirst({
        where: {
            organizationId: organization.id,
            user: {
                clerkUserId: userId
    ...
    if (!membership) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$organization$2d$sync$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["syncOrganizationMembership"])(userId, organization.clerkOrgId);
        membership = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].organizationMember.findFirst({
            where: {
                organizationId: organization.id,
                user: {
                    clerkUserId: userId
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        ...
                                        fileName: "[project]/app/(dashboard)/[orgSlug]/layout.tsx",
                                        lineNumber: 83,
                                        columnNumber: 15
                                    }, this),
...
"[project]/app/(dashboard)/[orgSlug]/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/app/(dashboard)/[orgSlug]/layout.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=_0uzu8rk._.js.map